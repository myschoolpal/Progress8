...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>Smart Move Data | Home</title>
						...
						<div class="col-xs-10 col-sm-6">
							...
							<div id="header-top-second"  class="clearfix">
								...
								<div class="header-top-dropdown">
									...
									<div class="btn-group dropdown">
										<button type="button" class="btn dropdown-toggle" data-toggle="dropdown"><i class="fa fa-shopping-cart"></i> Contact Us</button>
										<ul class="dropdown-menu dropdown-menu-right dropdown-animation cart">
											<li>
												<table class="table table-hover">
													<thead>
														<tr>
															<th class="quantity" colspan='3'>Contact Us</th>
													...
													<tbody>
														<tr>
															...
															<td class="product">info@smartmovedata.com</td>
															
														</tr>
														<tr>
															<td class="quantity">Phone</td>
															<td class="product">08.........</td>
															
														</tr>
														<tr>
															<td class="quantity">Fax</td>
															<td class="product">01302......</td>
						...
						<div class="col-md-3">
							...
							<div class="header-left clearfix">
								...
								<div class="site-slogan">
									Consistent approach to curriculum changes 
								</div>
											...
											<div class="collapse navbar-collapse" id="navbar-collapse-1">
												<ul class="nav navbar-nav navbar-right">
													...
													<li class="dropdown mega-menu">
														<a href="#" class="dropdown-toggle" data-toggle="dropdown">SMD Report</a>
														<ul class="dropdown-menu">
															<li>
																<div class="row">
																	<div class="col-lg-4 col-md-3 hidden-sm">
																		<h4>Clear Structured Reporting</h4>
																		<p>Data Analysis that empowers maximum impact.</p>
																	...
																	<div class="col-lg-8 col-md-9">
																		...
																		<div class="row">
																			<div class="col-sm-6">
																				<div class="divider"></div>
																				<ul class="menu">
																					<li><a href="overview.html"><i class="icon-right-open"></i>Overview</a></li>
																					<li><a href="overview.html#header-2"><i class="icon-right-open"></i>Attainment 8</a></li>
																					<li><a href="overview.html#header-3"><i class="icon-right-open"></i>Progress 8</a></li>
																					<li><a href="overview.html#header-4"><i class="icon-right-open"></i>Expected Attainment 8</a></li>
																					<li><a href="overview.html#header-5"><i class="icon-right-open"></i>Levels of Progress</a></li>
																					<li><a href="overview.html#header-6"><i class="icon-right-open"></i>Transition Matrices</a></li>
																			...
																			<div class="col-sm-6">
																				<div class="divider"></div>
																				<ul class="menu">
																					<li><a href="overview.html#header-7"><i class="icon-right-open"></i>A*-A, A*-C, A*-G</a></li>
																					<li><a href="overview.html#header-8"><i class="icon-right-open"></i>Statistical Significance</a></li>
																					<li><a href="overview.html#header-9"><i class="icon-right-open"></i>PP, SEN & EAL</a></li>
																					<li><a href="overview.html#header-10"><i class="icon-right-open"></i>Intervention Groups</a></li>
																					<li><a href="overview.html#header-11"><i class="icon-right-open"></i>English Literature Predictions</a></li>
																				</ul>
																			</div>
																		</div>
																	</div>
													...
													<!-- mega-menu end -->
													<li class="dropdown">
														<a href="features-pricing-tables-1.html" class="dropdown-toggle" data-toggle="dropdown">Packages</a>
														<ul class="dropdown-menu">
															<li><a href="features-pricing-tables-1.html">SMD Report</a></li>
															<li><a href="features-pricing-tables-1.html">SMD Report + Training</a></li>
														</ul>
													</li>
													
													<li class="dropdown">
														<a href="#" class="dropdown-toggle" data-toggle="dropdown">Curriculum Strategy</a>
														<ul class="dropdown-menu">
															<li><a href="components-tabs-and-pills.html"><i class="icon-right-open"></i>Overview</a></li>
															<li><a href="components-accordions.html"><i class="icon-right-open"></i>Why make changes?</a></li>
															<li><a href="components-social-icons.html"><i class="icon-right-open"></i>Progress 8 Accountability</a></li>
															<li><a href="components-buttons.html"><i class="icon-right-open"></i>Consultation Procedure</a></li>
															<li><a href="components-forms.html"><i class="icon-right-open"></i>Pricing</a></li>
														</ul>
													</li>
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															<li><a href="components-tabs-and-pills.html"><i class="icon-right-open"></i>SLT Training</a></li>
															<li><a href="components-accordions.html"><i class="icon-right-open"></i>Curriculum Leader Training</a></li>
															<li><a href="components-social-icons.html"><i class="icon-right-open"></i>Whole School Training</a></li>
															<li><a href="components-buttons.html"><i class="icon-right-open"></i>Data Team Training</a></li>
															<li><a href="components-forms.html"><i class="icon-right-open"></i>Pricing</a></li>
														</ul>
													</li>
													
													<li class="">
														<a href="blog-masonry-sidebar.html" >Blog</a>
													</li>
												</ul>
											</div>
						...
						<div class="slider-banner">
							<ul>
								...
								<div class="tp-caption default_bg large sfr tp-resizeme"
									...
									data-start="1200"
									data-end="9400"
									data-endspeed="600">Calculate your Progress 8 Score
								</div>
								...
								<div class="tp-caption light_gray_bg sfb medium tp-resizeme"
									...
									data-start="1600"
									data-end="9400"
									data-endspeed="600">Consistency across all subjects
								</div>
								...
								<div class="tp-caption light_gray_bg sfb medium tp-resizeme"
									...
									data-start="1800"
									data-end="9400"
									data-endspeed="600">Calculate Attainment and Progress 8 Score
								</div>
								...
								<div class="tp-caption light_gray_bg sfb medium tp-resizeme"
									...
									data-start="2000"
									data-end="9400"
									data-endspeed="600">Value Added by pupil, class and subject
								</div>
								...
								<div class="tp-caption light_gray_bg sfb medium tp-resizeme"
									...
									data-start="2200"
									data-end="9400"
									data-endspeed="600">Immediately identify intervention
								</div>
								...
								<div class="tp-caption white_bg large sfr tp-resizeme"
									...
									data-start="1200"
									data-end="9400"
									data-endspeed="600">Support your staff
								</div>
								...
								<div class="tp-caption white_bg sfb medium tp-resizeme"
									...
									data-start="1600"
									data-end="9400"
									data-endspeed="600">Performance by subject
								</div>
								...
								<div class="tp-caption white_bg sfb medium tp-resizeme"
									...
									data-start="1800"
									data-end="9400"
									data-endspeed="600">Performance by class
								</div>
								...
								<div class="tp-caption white_bg sfb medium tp-resizeme"
									...
									data-start="2000"
									data-end="9400"
									data-endspeed="600">Performance by pupil
								</div>
								...
								<div class="tp-caption white_bg sfb medium tp-resizeme"
									...
									data-start="2200"
									data-end="9400"
									data-endspeed="600">Provide teachers with target pupils
								</div>
								...
								<!-- main image -->
								<img src="images/slider-1-slide-1.jpg"  alt="kenburns"  data-bgposition="left center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-bgfit="100" data-bgfitend="115" data-bgpositionend="right center">
								...
								<div class="tp-caption white_bg large sfr tp-resizeme"
									...
									data-start="1200"
									data-end="9400"
									data-endspeed="600">Prepare yourself Progress 8
								</div>
								...
								<div class="tp-caption white_bg sfb medium tp-resizeme"
									...
									data-start="1600"
									data-end="9400"
									data-endspeed="600">Curriculum Consultation 
								</div>
								...
								<div class="tp-caption white_bg sfb medium tp-resizeme"
									...
									data-start="1800"
									data-end="9400"
									data-endspeed="600">SLT/Curriculum Leader Training
								</div>
								...
								<div class="tp-caption white_bg sfb medium tp-resizeme"
									...
									data-start="2000"
									data-end="9400"
									data-endspeed="600">Whole Staff Training
								</div>
								...
								<div class="tp-caption white_bg sfb medium tp-resizeme"
									...
									data-start="2200"
									data-end="9400"
									data-endspeed="600">Data Team Training
								</div>
								...
								<div class="tp-caption dark_gray_bg sfb medium tp-resizeme"
									...
									data-start="2400"
									data-end="9400"
									data-endspeed="600">Be ready for Progress 8 
								</div>
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<div class="call-to-action">
								<h1 class="title">Introduce Consistency Now</h1>
								<p>Now is the time to take a consistent approach to the analysis of progress and identification of intervention needs across all subjects.</p>
								<a class="btn btn-white more" data-toggle="modal" data-target="#myModal">
								What is Progress 8 ? <i class="pl-10 fa fa-info"></i>
								</a>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title" id="myModalLabel">Attainment 8 &amp; Progress 8</h4>
											</div>
											<div class="modal-body">
												<p>This is a brief overview of the key points behind the new progress 8 measure that is being introduced to all schools from 2016.</p>
												<ul class="list-icons">
													<li><i class="icon-check"></i> Points Score 1-8</li>
													<li><i class="icon-check"></i> Double Weighted Maths Score</li>
													<li><i class="icon-check"></i> Double Weighted English Score when taking English Literature</li>
													<li><i class="icon-check"></i> 3 Ebacc Subjects included</li>
													<li><i class="icon-check"></i> 3 Other Subjects included taken from a list of chosen subjects</li>
												</ul>
												<p>Each qualification receives a point score of 1-8, 8 being the highest. There are three separate sections to Attainment 8 these are 
												Maths + English, Other ebacc subjects and other subjects.  
												<br /><br />
												<strong>Maths &amp; English</strong>
												<br />
												Maths scores are doubled as are English scores assuming a pupil is 
												studying both English Literature and Language. 
												<br /><br />
												<strong>Other Ebacc Subjects</strong>
												<br />
												Other Ebacc subjects include: Science, Geography, History and Languages. For each pupil the best three subjects are chosen and included in the 
												Attainment 8 score.
												<br /><br />
												<strong>Other Subjects</strong>
												<br />
												Other subjects include a wide range of BTEC's, OCR Nationals and other qualifications. From these the top three results are chosen and included 
												in the Attainment 8 score. 
												<br />
												<br />
												The <strong>Attainment 8</strong> score can be converted to a <strong>Progress 8</strong> Score by subtracting the pupils' Expected Attainment 8 Score. The Expected Attainment 8
												score is calculated from each pupils' KS2 Fine Scores. 
								
												  </p>
											</div>
											<div class="modal-footer">
												<div class="col-md-4 col-md-offset-4">
													<button type="button" class="btn btn-sm btn-white"><i class="icon-check"></i> Further Information</button>
												</div>
												<div class="col-md-4">
			...
			<section class="main-container gray-bg">
				...
				<div class="main">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h1 class="text-center title">Key Features</h1>
								<div class="separator"></div>
								<p class="text-center">How can Smart Move Data make a difference ?  </p>
								<div class="row">
									<div class="col-sm-4">
										<div class="box-style-1 white-bg object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="0">
											<i class="fa fa-area-chart"></i>
											<h2>Progress 8 Prediction</h2>
											<p>Using progress summary data, calculate an accurate prediction of your progress 8 score.</p>
									...
									<div class="col-sm-4">
										<div class="box-style-1 white-bg object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="200">
											...
											<p>Use transition matrices to track the progress of a whole class or subject.</p>
											<a href="page-services.html" class="btn-default btn">Read More</a>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="box-style-1 white-bg object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="400">
											...
											<h2>Intervention Support</h2>
											<p>Provide curriculum leaders and teachers with a list of pupils needing extra support.</p>
											<a href="page-services.html" class="btn-default btn">Read More</a>
										</div>
									</div>
								</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="separator"></div>
							<p class="lead text-center">Supporting schools in preparing for the new <strong>Progress 8</strong> measure.</p>
							<br>
							<div class="row">
								<div class="col-md-6">
									<h2 class="title">Clear, Structured &amp; Supportive</h2>
									<div class="row">
										<div class="col-md-6">
											<img src="images/section-image-2.png" alt="">
										</div>
										<div class="col-md-6">
											<p>Smart Move Data uses 'in year' data to  provide schools, with a clear and structured PDF containing a wide range of data analysis including the new <strong>Progress 8</strong> measure, transition matrices and high impact support plans. </p>
										</div>
									</div>
									<p>The analysis we provide is designed to facilitate quality leadership within schools.</p>
											...
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
														<i class="fa fa-bar-chart-o"></i>Progress 8 
													</a>
												</h4>
											</div>
											<div id="collapseOne" class="panel-collapse collapse in">
												<div class="panel-body">
													The new Progress 8 measure will be introduced for all schools from 2016 it will be one of the headline figures recorded in performance tables,
													alongside Attainment 8 and A* - C percentages. There will be a new floor standard introduces based on the Progress 8 score, if a school's score
													should be below -0.5 this will indicate a school is significantly under-performing and will come under scrutiny. SmartMove Data will use current 
													data to provide a school with: a clear prediction of their <strong>Progress 8 </strong> score, areas of weakness and key pupils to target with 
													intervention. 
												</div>
											</div>
										</div>
											...
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" class="collapsed">
														<i class="fa fa-leaf"></i>Leadership
													</a>
												</h4>
											</div>
											<div id="collapseTwo" class="panel-collapse collapse">
												<div class="panel-body">
													SmartMove Data provide a clear picture of the progress throughout the school. The analysis has been designed to clearly deliver the next steps 
													that should be taken. This allows SLT to provide middle leaders with a concise document detailing the progress made and where intervention should
													be implemented. All teachers struggle with finding time to analyse data. Finding the balance between asking teachers to analyse data and 
													spend time planning requires good leadership and management skills. SmartMove Data will remove the necessity for teachers to analyse data as 
													a clear list of intervention pupils has already been generated.
												</div>
											</div>
										</div>
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion" href="#collapseThree" class="collapsed">
														<i class="fa fa-html5"></i>Curriculum Strategies 
													</a>
												</h4>
											</div>
											<div id="collapseThree" class="panel-collapse collapse">
												<div class="panel-body">
													A crucial aspect to achieving a high <strong>Progress 8</strong> score is to provide a strategic curriculum. There are many different variables
													that if structured correctly will drastically alter a schools progress 8 score. Stephen Howse, education consultant and CEO of SmartMove Data is
													 an expert in Progress 8, he designed and created the software used to generate a SMD report. He provides in-depth consultations on strategically 
													 designing your schools curriculum to have maximum impact on your progress 8 outcome. 
